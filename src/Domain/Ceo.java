...
/**
 * The Ceo class represents a CEO, extending the Person  abstract class and
...
public class Ceo extends Person implements HasID {
    ...
    /**
     * Constructs a new Ceo with the specified details.
     *
    ...
    /**
     * Returns a string representation of the Ceo object.
     *
